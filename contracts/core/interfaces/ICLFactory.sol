...
interface ICLFactory {
  ...
  /// @notice Emitted when the swapHookManager of the factory is changed
  /// @param swapHookManager The swapHookManager after the swapHookManager was changed
  event SwapHookManagerChanged(address indexed swapHookManager);
  ...
  /// @notice Returns the current swapHookManager of the factory
  /// @dev Can be changed by the current swap hook manager via setSwapHookManager
  /// @return The address of the factory swapHookManager
  function swapHookManager() external view returns (address);

  /// @notice Returns the factory-wide default swap hook used when a pool has no hook set
  /// @dev Can be changed by the current swap hook manager via setDefaultSwapHook
  ...
  /// @notice Updates the swapHookManager of the factory
  /// @dev Must be called by the current swap hook manager
  /// @param _swapHookManager The new _swapHookManager of the factory
  function setSwapHookManager(address _swapHookManager) external;
  ...
  /// @dev Must be called by the current swap hook manager. Reverts with 'LMM' if the array lengths differ.
