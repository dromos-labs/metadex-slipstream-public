...
interface ICLGaugeFactory {
  ...
  /// @notice Cap sentinel meaning "use factory defaultCap".
  function DEFAULT_CAP_INDICATOR() external view returns (uint128);
  ...
  /// @notice Resolves the effective emission cap for `gauge`.
  ...
  /// @notice Set factory-wide default emission cap.
   ...
   * @param _factoryData Optional factory params. First byte 0x01 encodes referral config.
