...
interface ICLGauge is IGauge {
  ...
  /**
   * @notice Emitted when a referral receives part of a position's accrued emissions.
   * @param _account The address of the LP staker whose emissions paid the referral.
   * @param _tokenId The tokenId of the staked position.
   * @param _referralAddress The referral recipient.
   * @param _amount The amount of emissions paid to the referral.
   */
  event ReferralPaid(
    address indexed _account, uint256 indexed _tokenId, address indexed _referralAddress, uint256 _amount
  );
  ...
  /**
   * @notice Address of the voting rewards manager linked to the gauge.
   * @return The address of the voting rewards manager.
   */
  ...
  /**
   * @notice Compatibility flag for the old voter.
   * @return Whether the gauge points to a real pool.
   */
