...
interface ILeafVoter {
  ...
  /**
   * @notice Returns the canonical gauge for a pool, or address(0) if none is registered.
   * @param _pool The pool to query.
   * @return The gauge address for `_pool`.
   */
  ...
  /**
   * @notice Current emergency council address.
   * @return The address of the emergency council.
   */
