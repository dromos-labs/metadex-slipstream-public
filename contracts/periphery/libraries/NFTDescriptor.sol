...
library NFTDescriptor {
  ...
  function constructTokenURI(ConstructTokenURIParams memory params) public pure returns (string memory) {
    ...
    string memory descriptionPartOne = generateDescriptionPartOne(
      escapeQuotes(params.quoteTokenSymbol), escapeQuotes(params.baseTokenSymbol), addressToString(params.poolAddress)
    );
    ...
    return string(abi.encodePacked('"name":"', name, '", "description":"', descriptionPartOne, descriptionPartTwo, '"'));
  }
