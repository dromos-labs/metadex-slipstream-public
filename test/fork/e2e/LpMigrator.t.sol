...
contract LpMigratorTest is BaseForkFixture {
  ...
  function testFork_MigrateSlipstreamToSlipstream_WithOldNftAndNewNft() public {
    ...
    uint256 amount0In = 1_748_958_694_696_034_312; // ~1.75 WETH
    uint256 amount1In = 2_999_999_999_999_999_999_962; // ~3k OP
    ...
    ILpMigrator.FromParams memory fromParams = ILpMigrator.FromParams({
      nft: address(nftFrom), tokenId: tokenId, amount0Min: 0, amount1Min: 0, amount0Extra: 0, amount1Extra: 0
    });
