...
contract MediumFeeToken1LiquidityOnlyTest is CLPoolSwapNoStakeTest {
  function setUp() public override {
    ...
    unstakedPositions.push(Position({tickLower: -2000 * tickSpacing, tickUpper: 0, liquidity: liquidity}));

    clCallee.mint(
      pool, users.alice, unstakedPositions[0].tickLower, unstakedPositions[0].tickUpper, unstakedPositions[0].liquidity
    );
