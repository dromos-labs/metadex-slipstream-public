...
contract MediumFeeToken1LiquidityOnlyPartiallyStakedTest is CLPoolSwapPartiallyStakedNoUnstakeFeeTest {
  function setUp() public override {
    ...
    stakedPositions.push(Position({tickLower: -2000 * tickSpacing, tickUpper: 0, liquidity: liquidity / 2}));
    unstakedPositions.push(Position({tickLower: -2000 * tickSpacing, tickUpper: 0, liquidity: liquidity / 2}));
