...
contract CalculateFeesTest is CLPoolTest {
  ...
  function test_FeesCalculatedCorrectlyDuringSwapsFullRangePositionsPartiallyStakedWithIntermediaryFlashLoan() public {
    uint256 liquidity = TOKEN_1 * 10;
  ...
  function test_FeesCalculatedCorrectlySwappingOutAndIntoStakedRangePosition() public {
    ...
    uint256 tokenId = nftCallee.mintNewCustomRangePositionForUserWith60TickSpacing(
      29_953_549_559_107_810, 29_953_549_559_107_810, -TICK_SPACING_60, TICK_SPACING_60, users.alice
    );
    ...
    // add 1 to get full precision
    uint256 totalFeeOnSwap = FullMath.mulDivRoundingUp(86e16, 3000, 1e6);
