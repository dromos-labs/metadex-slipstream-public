...
contract FlashTest is CLPoolTest {
  ...
  function setUp() public override {
    ...
    pool = CLPool(
      poolFactory.createPool({
        tokenA: address(token0), tokenB: address(token1), tickSpacing: tickSpacing, sqrtPriceX96: encodePriceSqrt(1, 1)
      })
    );
  ...
  function test_FlashIncreasesGaugeFeesByExpectedAmountAllPositionsStaked() public {
    uint256 tokenId = nftCallee.mintNewFullRangePositionForUserWith60TickSpacing(TOKEN_1 * 2, TOKEN_1 * 2, users.alice);
  ...
  function test_FlashAllowsDonatingToken0AndToken1PositionsPartiallyStakedUnstakedFeeIs15() public {
    ...
    assertEq(_token1, 50_853);

    uint256 feeGrowthGlobal0X128 = FullMath.mulDiv(17_000, Q128, TOKEN_1);
    uint256 feeGrowthGlobal1X128 = FullMath.mulDiv(37_587, Q128, TOKEN_1);
