...
contract UnitSwapHookLibBeforeFlash is UnitSwapHookLib {
  function test_WhenSwapHookIsAddressZero(uint24 _tickSpacingFee) external {
    ...
    uint24 _hookFee = swapHookLib.beforeFlash(address(0), _flashParams, factory, TICK_SPACING_60);
  ...
  function test_WhenCallFails(
    ...
    uint24 _hookFee = swapHookLib.beforeFlash(swapHook, _flashParams, factory, TICK_SPACING_60);
